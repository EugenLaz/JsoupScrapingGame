...
public class main {
    private static String pageLink = "https://rozetka.com.ua/produkty/c4624997/page=PageIndex;price=2-MaxPrice;sort=novelty/";
    ...
    public static void main(String[] args) throws IOException {
        ...
        result=new HashMap<>();
        while (maxPrise >= 2) {
            elementList = getRandomPage(maxPrise);
            getRandomProduct(elementList);
        }
    ...
    public static List getRandomPage(int maxPrice) throws IOException {
        ...
        Document doc;
             doc = Jsoup.connect(pageLink.replace("MaxPrice", String.valueOf(maxPrice)).replace("PageIndex", maxPageNumber)).get();
